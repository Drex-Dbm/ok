...
short_description: "This mod restarts the bot completely.",
...
subtitle: function(data) {
	return `Restarts via ${data.filename}`
},
...
<div style="float: left; width: 105%; padding-top: 16px;">
	File Name:<br>
	<input id="filename" class="round" type="text" value="bot.js"><br>
</div>
<div style="float: left; width: 105%; padding-top: 8px;">
	<h3>Note:</h3>
	All actions below this one, will not be executed anymore.
</div>`
},
...
action: function(cache) {
	...
	this.getDBM().Files.restartBot(this.getDBM().Bot, (filename.length !== undefined && filename !== '' ? filename : undefined));
},
