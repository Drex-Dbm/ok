module.exports = {
	...
	short_description: "This mod will search for something you insert on youtube.",
	...
	action: function (cache) {
		...
		const ytinfo = AddOns.require('youtube-info');
		const TimeFormat = AddOns.require('hh-mm-ss');
