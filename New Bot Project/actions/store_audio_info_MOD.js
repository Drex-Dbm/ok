...
action: function(cache) {
	...
	switch(action) {
		...
		case 12:
		case 13:
			if(typeof(Audio.queue[server.id]) !== 'object') {
	...
	switch(action) {
		case 0:
			result = new String(Audio.status('stopped', cache));
			break;
		case 1:
			result = new String(Audio.status('paused', cache));
			break;
		case 2:
			result = new String(Audio.status('playing', cache));
			break;
		case 3:
			result = new String(Audio.loopItem[server.id] == true ? true : false);
			break;
		case 4:
			result = new String(Audio.loopItem[server.id] == true ? true : false);
			break;
		case 5:
			result = new String(Audio.loopQueue[server.id] == true ? true : false);
			break;
		case 6:
			result = new String(Audio.loopQueue[server.id] == true ? true : false);
			break;
		case 7:
			result = new String(Audio.shuffleQueue[server.id] == true ? true : false);
			break;
		case 8:
			result = new String(Audio.shuffleQueue[server.id] == true ? true : false);
			break;
		case 9:
			result = new String(Audio.autoplay[server.id] == true ? true : false);
			break;
		case 10:
			result = new String(Audio.autoplay[server.id] == true ? true : false);
			break;
		case 11:
			result = Audio.queue[server.id].length > 0 ? Audio.queue[server.id].map(i => i = i[2]) : [];
			break;
		case 12:
			result = Audio.queue[server.id].length > 0 ? Audio.queue[server.id].map(i => i = i) : [];
			break;
		case 13:
			result = Audio.queue[server.id].length;
			break;
		case 14:
			result = Audio.autoplaydata.length > 0 ? Audio.autoplaydata.map(i => i = i.url) : [];
			break;
		case 15:
			result = Audio.autoplaydata.length > 0 ? Audio.autoplaydata.map(i => i = i.amount) : [];
			break;
		case 16:
			result = Audio.autoplaydata.length > 0 ? Audio.autoplaydata.map(i => i = i) : [];
			break;
		case 17:
