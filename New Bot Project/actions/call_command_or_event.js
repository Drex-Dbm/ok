...
<div id="info1"; style="float: left; width: 100%; padding-top: 16px; display: none;">
	Command/Event:<br>
...
<div id="info2" style="float: left; width: 111.1%; padding-top: 16px;">
	Command/Event ID:<br>
	<input id="source2" class="round" type="text" placeholder="Insert a Command/Event ID...">
</div>
<div style="float: left; width: 47.5%; padding-top: 16px;">
	Source Type:<br>
...
<div style="float: right; width: 47.5%; padding-top: 16px;">
	Call Type:<br>
